...
print(f"The high performing students of this session are: >>>>> \n", high_performers)
print(f"The average performing students of this session are: >>>>> \n", average_performers)
print(f"The low performing students of this session are: >>>>>  \n", low_performers)

high = len(high_performers)
average = len(average_performers)
low = len(low_performers)

print(f"This session we had {high} High performing students. \n")
print(f"This session, we had {average} Average performing students. \n")
print(f"This session, we had {low} Low performing students. \n")
